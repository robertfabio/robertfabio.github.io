...
const translations = {
  'pt-BR': {
    ...
    'projects-cacc': 'Site do Centro Acadêmico de Ciência da Computação - Desenvolvido com React, Node.js e Tailwind CSS',
    ...
    // Email
    'email-copied': 'Email copiado para a área de transferência!',
  ...
  'en-US': {
    ...
    'projects-cacc': 'Computer Science Academic Center Website - Developed with React, Node.js and Tailwind CSS',
